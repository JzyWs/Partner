...
<title>登录|疫情上报系统</title>
<meta name="keywords" content="疫情上报系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生疫情上报系统</h2>
</div>
  ...
  <div id="loginform" class="loginBox">
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="mt-20 skin-minimal" style="text-align: center;">
      	...
      	<div class="radio-box">
			<input type="radio" id="radio-2" name="type" checked value="4" />
			<label for="radio-1">老师</label>
		</div>
		...
		<div class="radio-box">
			...
			<label for="radio-2">学院负责人</label>
		</div>
		<div class="radio-box">
			<input type="radio" id="radio-1" name="type" value="1" />
			<label for="radio-3">学校防疫办</label>
		</div>
	</div> 
